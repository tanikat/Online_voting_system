...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card col-md-5 offset-1 bg-warning float-left">
				<div class="card-body text-white">
					
		
					<span class="card-icon"><i class="fa fa-users"></i></span> <h4><b>Voters</b></h4>
					<h3 class="text-right"><b><?php echo $conn->query('SELECT * FROM users where type = 2 ')->num_rows ?></b></h3>
				</div>
			</div>
			<div class="card col-md-5 offset-1 bg-info ml-4 float-left">
				<div class="card-body text-white">
					<span class="card-icon"><i class="fa fa-user-tie"></i></span><h4><b>Voted</b></h4>
